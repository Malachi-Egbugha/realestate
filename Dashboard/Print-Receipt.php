...
class myPDF extends FPDF{
  ...
  function header1($row,$entryDate,$dob,$bar){
    ...
    $this->Image('./assets/img/kadpoly.png', 7, 10, 'C');
...
$this->Cell(60,54,$this->Image('uploads/IMG_20201124_174621_0~2.jpg', 13, 62, 40, 49) , 1,0, 'C');
$x = $this->GetX();
$this->SetFont('Arial', 'B', 10);
...
$this->SetFont('Arial', 'B', 10);
$this->Cell(60,9,'English Language', 1,0);
$this->SetFont('Arial', '', 10);
$this->Cell(130,9,'A1', 1,1);
$this->SetFont('Arial', 'B', 10);
$this->Cell(60,9,'Mathematics:', 1,0);
$this->SetFont('Arial', '', 10);
$this->Cell(130,9,'F9 ', 1,1);
$this->SetFont('Arial', 'B', 10);
$this->Cell(60,9,'Biology:', 1,0);
$this->SetFont('Arial', '', 10);
$this->Cell(130,9,'C6', 1,1);
$this->SetFont('Arial', 'B', 10);
$this->Cell(60,9,'Chemistry:', 1,0);
$this->SetFont('Arial', '', 10);
$this->Cell(130,9,'B3', 1,1);
$this->SetFont('Arial', 'B', 10);
$this->Cell(60,9,'Physics', 1,0);
$this->SetFont('Arial', '', 10);
$this->Cell(130,9,'A1', 1,1);
$this->SetFont('Arial', 'B', 10);
$this->Cell(60,9,'Geography:', 1,0);
$this->SetFont('Arial', '', 10);
$this->Cell(130,9,'F9 ', 1,1);
$this->SetFont('Arial', 'B', 10);
$this->Cell(60,9,'Agricultural Science:', 1,0);
$this->SetFont('Arial', '', 10);
$this->Cell(130,9,'C6', 1,1);
$this->SetFont('Arial', 'B', 10);
$this->Cell(60,9,'Economics:', 1,0);
$this->SetFont('Arial', '', 10);
$this->Cell(130,9,'B3', 1,1);
$this->SetFont('Arial', 'B', 10);
$this->Cell(60,9,'Data Processing:', 1,0);
$this->SetFont('Arial', '', 10);
$this->Cell(130,9,'B3', 1,1);
$this->Ln();
...
$this->SetFont('Arial', 'B', 10);
$this->Cell(190,9,'Next of Kin Details', 1,1, 'C');
$this->SetFont('Arial', 'B', 10);
...
$pdf->AliasNbPages();
$pdf->AddPage('P', 'A4', 0);
$pdf->header1($row,$entryDate,$dob,$bar);
// $pdf->headerTable();
// $pdf->viewTable();
$pdf->Output();
