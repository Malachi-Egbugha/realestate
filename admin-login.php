...
<!-- 
        <div class="section-title">
          ...
          <div class="col-md-6 offset-sm-3 mt-5">
                        ...
                        <div class="box-header" style="background-color: #eee;">Admin Login</div>
                        <!-- /.box-header -->
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <form method="POST">
                                       <div class="row">
                                        ...
                                        <div class="form-group col-md-6 offset-sm-4" style="margin-top: 20px;">
                                            <button name="login" type="submit" class="form-control btn btn-primary bgcolorr">Submit</button>
                                        </div>
                                        </div>
                                    </form>
                                </div>
