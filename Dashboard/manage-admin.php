                                 ...
                                 <table class="table table-responsive-md table-hover table-bordered table-stripped" style="font-size: 11px;">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td><?php echo $row["firstname"]." ".$row["lastname"]." ".$row["othernames"];?></td>
                                      ...
                                      <!--   <td><a href="uploads/<?php echo $row["PICTURE"];?>" class="btn btn-success btn-sm fa fa-camera"> View Picture</a></td> -->
                                       <!--  <td><a href="edit_admin.php?id=<?php echo $row["admin_id"];?>" class="btn btn-success btn-sm fa fa-edit"> Edit</a> </td> -->
                                        <td><a href="confirm-admin.php?id=<?php echo $row["admin_id"];?>" class="btn btn-danger btn-sm fa fa-trash w-100" onclick="return confirm ('Are you sure you want to Delete this Record')"> Delete</a></td>
                                      </tr>
                                    </tbody>
