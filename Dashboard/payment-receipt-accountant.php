...
$operation->accountant_controll_access();
                       ...
                       <!--  <div class="card-action">
                        ...
                        <div class="card-content">
                              ...
                              <tr>
                                ...
                                <td style="font-weight: bold;"><?php echo $result["property_location"]?></td>
                              </tr>

                              <tr>
                                <td style="font-weight: bold;">State</td>
                                <td style="font-weight: bold;"><?php echo $result["state"]?></td>
                              </tr>

                              <tr>
                                <td style="font-weight: bold;">LGA</td>
                                <td style="font-weight: bold;"><?php echo $result["lga"]?></td>
                              </tr>
                            ...
                            <table class="table tb table-responsive-md " style="border: 1px solid #ccc;">
                              <tr>
                                ...
                                <div class="col-md-6 col-sm-offset-1 mt-5 ">
                                  <a href="BAYMOON-INVESTMENT-FORM-ACCOUNTANT.php" class="pull-right btn" style="background-color: #242424; color: #fff;">Print</a>
                                </div>
