...
$this->SetX($x);
$this->SetFont('Arial', 'B', 10);
$this->Cell(40,9,'Property Location:', 1,0);
$this->SetFont('Arial', '', 10);
$this->Cell(120,9, $row["property_location"], 1,1);
$this->SetX($x);
$this->SetFont('Arial', 'B', 10);
$this->Cell(40,9,'State:', 1,0);
$this->SetFont('Arial', '', 10);
$this->Cell(120,9, $row["state"], 1,1);
$this->SetX($x);
$this->SetFont('Arial', 'B', 10);
$this->Cell(40,9,'LGA:', 1,0);
$this->SetFont('Arial', '', 10);
$this->Cell(120,9, $row["lga"], 1,1);
$this->SetX($x);
$this->SetFont('Arial', 'B', 10);
