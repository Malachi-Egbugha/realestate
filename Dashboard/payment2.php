...
if (isset($_POST['add-cart'])) {
  $operation -> insert_cart($roww["fname"],$roww["lname"],$roww["oname"],$roww["email"],$roww["phone"],$roww["amount"],$roww["number_plot"]);

  $msg="<div class='col-md-12 text-center bg-success text-white'>Added to Cart Sucessfully</div>";
}
                           ...
                           <?php echo  $msg;?>
                                  ...
                                  <div class="form-group">
                                    <div class="col-lg-6 col-sm-offset-3">
                                      ...
                                      <form method="post">  
                                         <button class="btn btn-danger text-light form-control fa fa-shopping-cart" name="add-cart" type="submit"> ADD TO CART</button></form> 
                                    </div>   
                                  </div>
