<nav class="navbar navbar-default top-navbar" role="navigation"  style="background-color: #2c544d; color: white">
            <div class="navbar-header"  style="background-color: #2c544d; color: white">
                ...
                <a class="navbar-brand waves-effect waves-dark" href="#" style="background-color: #2c544d; font-size: 20px;">  <strong><img src="assets/img/BAYMON.PNG" height="40" width="50"> Bayinoest</strong></a>
