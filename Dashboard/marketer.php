       ...
       <?php include('marketer-sidebar.php'); ?>
		...
		<div id="page-wrapper" >
		  <div class="header"> 
						...
						<ol class="breadcrumb">
					  <li><a href="marketer.php">Home</a></li>
					  <li><a href="marketer.php">Dashboard</a></li>
					</ol> 
...
<div class="dashboard-cards"> 
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-3">
            ...
            <strong style="font-size: 12px;">ADD ADMIN</strong>
            </div>
            </div>
            </div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
            ...
            <div class="card-action">
            <strong style="font-size: 12px;">ADD PROPERTY</strong>
            </div>
            </div>
            </div> 
        </div>
        <div class="col-xs-12 col-sm-6 col-md-3">
           ...
           <!--  <?php
            ...
            <div class="card-action">
            <strong style="font-size: 12px;">ADD CUSTOMER</strong>
            </div>
            </div>
            </div> 
